...
--(Also there is option for recursive crawl all links/pages that are on the initial page. This could be set in the HomeController, if you call StartCrawlerAsync
